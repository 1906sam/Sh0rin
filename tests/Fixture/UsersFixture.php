...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'email_id' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'user_email_index3' => ['type' => 'index', 'columns' => ['username', 'email_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created_date' => '2016-11-15 15:39:57',
            'modified_date' => '2016-11-15 15:39:57'
        ],
    ];
}
